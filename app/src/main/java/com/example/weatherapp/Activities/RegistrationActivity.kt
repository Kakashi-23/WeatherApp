...
class RegistrationActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener {
    ...
    lateinit var postOffice: PincodeDetails.PostOffice
    ...
    private fun checkEnteredData() {
        ...
        intent.putExtra("cityName", postOffice.district)
    ...
    private fun getPincodeDetails(pincode: Int) {
        if (checkConnection(this)) {
            ...
            call.enqueue(object : Callback<ArrayList<PincodeDetails>> {
                override fun onResponse(
                    ...
                    if (body != null) {
                        ...
                        postOffice = mainData.postOfficeDetails.get(0)
            ...
            Toast.makeText(
                this@RegistrationActivity, "No Internet Connection",
                Toast.LENGTH_SHORT
            ).show()
        }
    }
